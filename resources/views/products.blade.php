...
<html lang="en">
  <head>
    ...
    <title>Laravel 9 Ajax Crud with Pagination & Search</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-5">
                <h2 class="text-center text-bold bg-secondary text-white">Laravel 9 Ajax Crud with Pagination & Search</h2>
                <div class="row">
                    <div class="col-lg-3">
